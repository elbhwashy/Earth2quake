...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray featureArray = jsonObj.getJSONArray("features");
            for (int i = 0; i < featureArray.length(); i++) {
                ...
                Earthquake earthquake = new Earthquake(magnitude, locationOffset,primaryLocation, dateToDisplay,timeToDisplay,url);
